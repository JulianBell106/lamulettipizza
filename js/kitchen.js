...
/* iOS Firestore heartbeat — resubscribes the orders listener periodically.
 * On iOS Safari, Firestore WebSocket connections silently stop delivering
 * "document modified" events while still delivering "document added" events.
 * Resubscribing every 20s forces a fresh snapshot with current server data.
...
function startDashboard() {
  ...
  startIOSHeartbeat();   // iOS fix — resubscribe listener to recover silent WebSocket drops
}
